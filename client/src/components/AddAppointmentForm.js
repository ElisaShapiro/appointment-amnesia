        ...
        <div> 
            <form onSubmit={handleSubmit}>
                <div>
                    ...
                    <select onChange={manageFormData} type="select" name="category" value={formData.category}>
                ...
                <div>
                    ...
                    <select onChange={manageFormData} type="select" name="provider" value={formData.provider}>
